...
from nlb_lightning.models import LangevinAutoencoder
...
def train(
    ...
    callbacks = [ModelCheckpoint(monitor="valid/loss", save_last=True, mode="min"),LearningRateMonitor(logging_interval='step')]
    if phase == "val":
        callbacks.extend(
            [
    ...
    save_path = os.path.join(runtag_dir, f"submission5-{phase}.h5")
