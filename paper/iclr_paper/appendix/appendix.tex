...
% Set supplementary figure and table numbering
...
To maintain blinding, software and data availability information can be found in the anonymized repository at \url{https://anonymous.4open.science/r/F3E2-ocsidln/README.md}. Full reproduction of \nameref{section:results} and \nameref{subsection:additional_results} is possible through code and artifacts found in the \texttt{experiments/} directory.
...
Beyond this conceptual distinction, we compare NLDisco with other neural latent variable methods across 15 methodological features (\autoref{table:method_comparisons}):
...
% Keep the comparison table within Methods Comparison.
\clearpage
