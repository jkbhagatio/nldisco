...
The code repository containing the NLDisco implementation alongside tutorial notebooks and data access instructions to replicate the results in this paper is available at \url{https://github.com/jkbhagatio/nldisco}.
...
\subsubsection{Macaque motor cortex spike data in a reaching task}
\label{subsubsection:churchland_results_details}
