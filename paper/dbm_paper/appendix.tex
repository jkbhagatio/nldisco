...
The 96 noise neurons had stable mean firing rates sampled uniformly between 1 and 5 Hz. The resulting spike count matrix was used to train a single-layer SAE with 128 latents and a sparsity constraint of 4 active latents per timebin.
